...
public class GrUnitVO implements Serializable {
    ...
    private List<GrUnitVO.ViceUnit> viceUnitList = new ArrayList<>();

    @Schema(description = "删除列表")
    private List<Long> viceUnitListDelete;

    @Data
    @AllArgsConstructor
    @NoArgsConstructor
    @Schema(description = "副单位")
    public static class ViceUnit {
