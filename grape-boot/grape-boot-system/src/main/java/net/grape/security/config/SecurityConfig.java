package net.grape.security.config;

import lombok.AllArgsConstructor;
import net.grape.framework.security.mobile.MobileAuthenticationProvider;
...
import net.grape.framework.security.third.ThirdAuthenticationProvider;
