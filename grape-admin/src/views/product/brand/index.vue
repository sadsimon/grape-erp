<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList">
			<el-form-item style="width: 400px" prop="param">
				<el-input v-model="state.queryForm.param" placeholder="按品牌编号，品牌名称查询"></el-input>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<el-table-column prop="categoryName" label="品牌类别" header-align="center" align="center" />
			<el-table-column prop="brandCode" label="品牌编号" header-align="center" align="center"></el-table-column>
			<el-table-column prop="brandName" label="品牌名称" header-align="center" align="center"></el-table-column>
			<el-table-column label="状态" header-align="center" align="center">
				<template #default="{ row }"><GrDataSwitch :id="row.id" v-model="row.state" url="/product/grBrand" /></template>
			</el-table-column>
		</el-table>
		<el-pagination
		...
		<!-- 新增 / 修改 -->
		<BrandAddOrUpdate ref="addOrUpdateRef" @refresh-data-list="getDataList"></BrandAddOrUpdate>
	</el-card>
</template>

<script setup lang="ts" name="ProductBrandIndex">
