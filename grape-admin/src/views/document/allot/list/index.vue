<template>
		...
		<GrSelectableTable  :height="listHeight" ref="tableRef" :initial-data="tableData" :fields="fields" :summaries="showSummaries">
			<template #columns>
				...
				<el-table-column prop="storeId" align="center" label="调出仓库">
					<template #default="scope">
				...
				<el-table-column prop="inStoreId" align="center" label="调入仓库">
					<template #default="scope">
						<GrStoreInput :disabled="isfinish" v-model="scope.row['inStoreId']" readonly></GrStoreInput>
					</template>
				</el-table-column>
