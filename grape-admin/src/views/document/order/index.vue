		...
		<el-container class="layout-container">
			<el-card class="head layout-query">
				<el-form ref="saveRef" :inline="true" :rules="dataRules" :model="dataForm">
					<div style="font-size:20px; text-align:center;margin-bottom: 15px;">采购入库单</div>
					...
					<el-form-item prop="contactunitsId" label="供货单位">
						<GrContactunitsInput width="250px" :disabled="isfinish" :type="'0'" :title="'供货单位'" v-model="dataForm.contactunitsId"></GrContactunitsInput>
					</el-form-item>
...
<script setup lang="ts" name="DocumentOrderIndex">
